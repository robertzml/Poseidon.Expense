...
namespace Poseidon.Expense.ClientDx
{
    ...
    /// 气费单据组件
    /// </summary>
    public partial class GasReceipt : DevExpress.XtraEditors.XtraUserControl
    {
        #region Field
        /// <summary>
        /// 当前关联账户
        ...
        private void LoadReceipts()
        {
            ...
            var receipts = BusinessFactory<GasExpenseBusiness>.Instance.FindByAccount(this.currentAccount.Id).OrderByDescending(r => r.BelongDate);
            this.bsGasExpense.DataSource = receipts;
        }

        /// <summary>
        /// 显示气费支出信息
        /// </summary>
        /// <param name="entity">气费支出</param>
        private void ShowGasExpense(GasExpense entity)
        {
        ...
        /// <param name="e"></param>
        private void GasReceipt_Load(object sender, EventArgs e)
        {
            if (!this.DesignMode)
            {
                this.lbGasReceipt.DrawItem += EventUtil.lbMonth_DrawItem;
            }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void lbGasReceipt_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.lbGasReceipt.SelectedValue == null)
            {
                Clear();
                return;
            }

            ShowGasExpense(this.lbGasReceipt.SelectedItem as GasExpense);
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            ChildFormManage.ShowDialogForm(typeof(FrmGasExpenseAdd), new object[] { this.currentAccount.Id });
            LoadReceipts();
        }
        ...
        {
            if (this.currentAccount == null || this.lbGasReceipt.SelectedValue == null)
                return;

            var expense = this.lbGasReceipt.SelectedItem as GasExpense;
            ChildFormManage.ShowDialogForm(typeof(FrmGasExpenseEdit), new object[] { expense.Id, this.currentAccount.Id });
            LoadReceipts();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageUtil.ConfirmYesNo("是否确认删除选中气费支出") == DialogResult.Yes)
            {
                try
                {
                    var result = BusinessFactory<GasExpenseBusiness>.Instance.Delete(expense);
