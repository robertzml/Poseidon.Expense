...
namespace Poseidon.Expense.ClientDx
{
    ...
    /// 水费支出单据管理控件
    /// </summary>
    public partial class WaterReceipt : DevExpress.XtraEditors.XtraUserControl
    {
        #region Field
        /// <summary>
        /// 当前关联账户
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            ChildFormManage.ShowDialogForm(typeof(FrmWaterExpenseAdd), new object[] { this.currentAccount.Id });
            LoadReceipts();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            ChildFormManage.ShowDialogForm(typeof(FrmWaterExpenseEdit), new object[] { expense.Id, this.currentAccount.Id });
            LoadReceipts();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageUtil.ConfirmYesNo("是否确认删除选中水费支出") == DialogResult.Yes)
            {
                try
                {
                    var result = BusinessFactory<WaterExpenseBusiness>.Instance.Delete(expense);
