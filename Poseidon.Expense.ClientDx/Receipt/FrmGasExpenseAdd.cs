...
namespace Poseidon.Expense.ClientDx
{
    ...
    /// 登记气费支出窗体
    /// </summary>
    public partial class FrmGasExpenseAdd : BaseSingleForm
    {
        #region Field
        /// <summary>
        /// 当前关联支出账户
        ...
        #region Constructor
        public FrmGasExpenseAdd(string accountId)
        {
            InitializeComponent();
        ...
        protected override void InitForm()
        {
            ...
            ControlUtil.BindDictToComboBox(this.cmbFeeType, typeof(GasExpense), "FeeType");
        ...
        {
            List<GasExpenseRecord> records = new List<GasExpenseRecord>();

            foreach (var item in this.currentAccount.GasMeters)
            {
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                BusinessFactory<GasExpenseBusiness>.Instance.Create(entity, this.currentUser);
