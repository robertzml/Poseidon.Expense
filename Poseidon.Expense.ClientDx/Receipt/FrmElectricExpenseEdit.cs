...
namespace Poseidon.Expense.ClientDx
{
    ...
    /// 编辑电费支出窗体
    /// </summary>
    public partial class FrmElectricExpenseEdit : BaseSingleForm
    {
        #region Field
        /// <summary>
        /// 当前关联支出
        ...
        #region Constructor
        public FrmElectricExpenseEdit(string id, string accountId)
        {
            InitializeComponent();
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var result = BusinessFactory<ElectricExpenseBusiness>.Instance.Update(entity, this.currentUser);
