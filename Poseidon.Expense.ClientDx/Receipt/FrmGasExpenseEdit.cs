...
namespace Poseidon.Expense.ClientDx
{
    ...
    /// 编辑气费支出窗体
    /// </summary>
    public partial class FrmGasExpenseEdit : BaseSingleForm
    {
        #region Field
        /// <summary>
        /// 当前关联支出
        /// </summary>
        private GasExpense currentExpense;
        ...
        #region Constructor
        public FrmGasExpenseEdit(string id, string accountId)
        {
            InitializeComponent();
        ...
        {
            this.currentExpense = BusinessFactory<GasExpenseBusiness>.Instance.FindById(id);
        ...
        protected override void InitForm()
        {
            ...
            ControlUtil.BindDictToComboBox(this.cmbFeeType, typeof(GasExpense), "FeeType", this.currentExpense.FeeType);
            ...
            var last = BusinessFactory<GasExpenseBusiness>.Instance.FindLast(this.currentAccount.Id);
            if (last != null)
            {
            ...
            this.upTool.Init(this.currentExpense.AttachmentIds);
        ...
        private void SetEntity(GasExpense entity)
        {
