...
namespace Poseidon.Expense.Core.BL
{
    ...
    /// 热水费用支出业务类
    /// </summary>
    public class HotWaterExpenseBusiness : AbstractBusiness<HotWaterExpense>, IExpenseData
    {
        #region Constructor
        /// <summary>
        /// 热水费用支出业务类
        ...
        /// <param name="user">操作用户</param>
        /// <returns></returns>
        public (bool success, string errorMessage) Update(HotWaterExpense entity, ILoginUser user)
        {
            entity.UpdateBy = new UpdateStamp
            {
                UserId = user.Id,
